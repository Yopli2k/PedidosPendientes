...
/**
 * LineSupplierOrderPending detail model.
 *
 * @author Jose Antonio Cuello Principal <yopli2000@gmail.com>
 */
class LineSupplierOrderPending extends JoinModel
{
    ...
    public function __construct(array $data = array())
    {
        ...
        $this->setMasterModel(new LineaPedidoProveedor());
    }
    ...
    protected function getFields(): array
    {
        return [
            ...
            'pendienteeuros' => '(lp.cantidad - lp.servido) * COALESCE(lp.pvpunitario, 0.00) / cp.tasaconv',

            'coddivisa' => 'cp.coddivisa',
            'codigo' => 'cp.codigo',
            'codproveedor' => 'cp.codproveedor',
            'idempresa' => 'cp.idempresa',
            'nick' => 'cp.nick',
            'nombre' => 'cp.nombre',
            'tasaconv' => 'cp.tasaconv',
    ...
    {
        return 'lineaspedidosprov lp'
            . ' INNER JOIN pedidosprov cp ON cp.idpedido = lp.idpedido'
